...
design_view = {
  "_id": "_design/list",
  "_rev": "5-78a73b7c239fb62c70eb543aafefeece",
  "views": {
    "diao": {
...
url="http://admin:password@127.0.0.1:5984/daily_"+today+"/_design/list/_view/falmerjianlong"
...
# 市净率	float64	-
    ...
    s = {'日期': date, '代码': ""+code+"", '名称': name, '开盘价': open, '收盘价':close,'模型': mode}
...
result.to_csv("~/"+today+"_"+mode+".csv", encoding="gbk", index=True)
