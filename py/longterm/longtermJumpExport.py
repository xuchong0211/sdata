...
url ="http://admin:password@127.0.0.1:5984/longterm_20220811/_design/months/_view/jump?reduce=false"
...
result = pd.DataFrame(data_list, columns=['代码', '名称', '1月开盘价', '12月最高价', '最高价差','买点',
                                          '1月收盘价','1月盈利','1月盈利百分比',
                                          '2月收盘价','2月盈利','2月盈利百分比',
                                          '3月收盘价','3月盈利','3月盈利百分比',
                                          '4月收盘价','4月盈利','4月盈利百分比',
...
result.to_csv("~/longterm_jump_stock.csv", encoding="gbk", index=False)
